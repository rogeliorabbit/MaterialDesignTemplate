...
public class TabThree extends Fragment {
    ...
    private void initializeData(){
        ...
        routes.add(new Get_Routes("Ruta3 1", "9 km", R.drawable.cardviewbackground));
        routes.add(new Get_Routes("Ruta3 2", "5 km", R.drawable.cardviewbackground));
        routes.add(new Get_Routes("Ruta3 3", "3 km", R.drawable.cardviewbackground));
        routes.add(new Get_Routes("Ruta3 4", "2 km", R.drawable.cardviewbackground));
        routes.add(new Get_Routes("Ruta3 5", "8 km", R.drawable.cardviewbackground));
    }
    ...
    public void onDestroyView() {
        super.onDestroy();
        //Toast.makeText(getActivity(), "onDestroy Tab3", Toast.LENGTH_SHORT).show();
    }
